...
export const vehicle = {
  ...
  summary: 'A full-size 12-passenger LT van with a 6.0L V8 and room to bring the whole family along for school, activities, road trips, and everyday life.',
  description: [
  ...
  highlights: ['Seating for up to 12 passengers', 'Bring the whole family in one vehicle', 'Curtain airbags for the first three rows', 'Ideal capacity for carpools and family trips'],
  facts: [
    { label: 'Make & model', value: 'Chevrolet Express 3500' },
    { label: 'Year & trim', value: '2012 LT' },
    { label: 'Engine', value: '6.0L L96 V8' },
    { label: 'Fuel', value: 'Gasoline / E85 flex fuel' },
    { label: 'Drivetrain', value: '4×2' },
    { label: 'Body style', value: 'Passenger van · 4 doors' },
    { label: 'Seating', value: '12 passengers' },
    { label: 'GVWR class', value: '9,001–10,000 lb' },
    { label: 'Built in', value: 'Wentzville, Missouri' },
  ],
  notes: [
